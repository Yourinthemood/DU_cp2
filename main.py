...
def main():
    ...
    options = ["Add Character", "Manage Skills", "Manage Inventory", "Manage Attributes", "View / Compare Characters", "Select / Search Characters", "Help", f' (Your current selected character is "{selected_character}")', "Visualization", "Statistics", "Random Generator"]
